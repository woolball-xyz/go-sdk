...
// APIClient manages communication with the Woolball AI Network API API vv1
...
type APIClient struct {
	...
	SpeechRecognitionApi *SpeechRecognitionApiService

	TextGenerationApi *TextGenerationApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.SpeechRecognitionApi = (*SpeechRecognitionApiService)(&c.common)
	c.TextGenerationApi = (*TextGenerationApiService)(&c.common)
